#
#  Be sure to run `pod spec lint AtomSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ironSource/atom-ios.git", :tag => "1.1.2" }
  ...
  s.source_files  = "atom-sdk/objective-c/AtomSDK", "atom-sdk/objective-c/AtomSDK/AtomSDK/*.{h,m}"

  s.public_header_files = "atom-sdk/objective-c/AtomSDK/AtomSDK/ISAtom.h", "atom-sdk/objective-c/AtomSDK/AtomSDK/ISAtomTracker.h", "atom-sdk/objective-c/AtomSDK/AtomSDK/ISResponse.h", "atom-sdk/objective-c/AtomSDK/AtomSDK/ISUtils.h"
